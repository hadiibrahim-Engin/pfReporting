...
def mock_config() -> PFReportConfig:
...
def mock_loading_results() -> list[LoadingResult]:
    return [
        LoadingResult(name="Lne_OK",    type="Line", loading_pct=50.0, i_ka=0.3, i_nenn_ka=0.6),
        LoadingResult(name="Lne_Warn",  type="Line", loading_pct=80.0, i_ka=0.5, i_nenn_ka=0.6),
        LoadingResult(name="Lne_Viol",  type="Line", loading_pct=100.0, i_ka=0.6, i_nenn_ka=0.6),
        LoadingResult(name="Lne_Viol2", type="Line", loading_pct=120.0, i_ka=0.7, i_nenn_ka=0.6),
    ]
...
def mock_n1_results() -> list[N1Result]:
    return [
        N1Result(
            outage_element="Lne_A", type="Line", converged=True,
        ...
        N1Result(
            outage_element="Lne_B", type="Line", converged=True,
            ...
            violations=["Overload: Lne_C at 102.0%"],
        ),
        N1Result(
            outage_element="Trafo_A", type="Transformer (2W)", converged=False,
